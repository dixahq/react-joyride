...
- `clickTroughCallback`: Takes a function and fires it after the user has clicked trough the hole e.g. `clickTroughCallback: () => { document.querySelector('.projects .list #callback-real-button').click(); }`,
